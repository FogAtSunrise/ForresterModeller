...
namespace Swordfish.NET.Charts
{
    ...
    public partial class ColorLabel : UserControl, INotifyPropertyChanged
    {
        ...
        {
            ColorLabel colorLabel = (ColorLabel)dependency;
            colorLabel.Text = (string)e.NewValue;
            colorLabel.Measure(new Size(double.PositiveInfinity, double.PositiveInfinity));
            colorLabel.Width = colorLabel.DesiredSize.Height;
        }
